(function () {
  ...
  function render(container, config, text) {
    ...
    var title = get(text, 'crypto.title') || 'pay with crypto';
    var description = get(text, 'crypto.description') || 'we accept every cryptocurrency below. send to the address for your chain.';
